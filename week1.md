...
<img width=400 height=270 src="https://velog.velcdn.com/images/iyeeun/post/24b5d239-a100-4590-93b9-619ed0b58acb/image.png" />

피어 피드백 세선에서 노래를 틀고 진행하지는 않고, 따로 개설했던 피어 채널에 공유하는 형식으로 진행했습니다.   
저는 무료 버전 ChatGPT를 사용했는데, 처음에는 제대로 된 노래 추천이 될지 의문이 있었는데 생각보다는 추천을 잘해줘서 신기했습니다. (없는 노래를 추천해주지는 않았습니다.)   
다만 다른 프롬프트 없이 노래 추천만 해달라고 했을 때는 괜찮았지만, 가사 기반으로 추천해달라고 했을 때는 자꾸 없는 가사를 창작하면서 추천해줘서 진짜 이런 노래가 맞는지 따로 확인하는 작업을 추가적으로 해줘야 했습니다. (ChatGPT한테 다시 확인해도 다른 가사로 바꿔서 또 창작했습니다.. 😓)   
그리고 동일한 노래를 반복해서 추천하는 경향이 있어서 피어 채널에 공유할 때는 중복은 제거하고 공유했습니다.

<img width=400 height=330 src="https://velog.velcdn.com/images/iyeeun/post/b36dbb94-d634-407d-9ed2-3300fb1b6c93/image.png" />

나중에는 웹 검색 기반으로 추천을 받아 할루시네이션을 줄이려고 했고, 실제로도 더 나은 결과를 얻을 수 있었습니다.   

비록 미션을 수행하는 데에 있어서 AI의 역할이 중요한 퀘스트는 아니었지만,   
AI의 한계가 뭔지, 어떻게 하면 더 나은 결과를 얻을 수 있는지를 학습할 수 있는 기회가 되었고   
아이스브레이킹에 확실히 도움이 되었다고 생각해서 좋은 퀘스트였다고 생각합니다.   
또 결과의 정확도가 비교적 중요하지 않은 퀘스트라고 생각해서 할루시네이션도 하루를 웃으면서 시작할 수 있는 재미있는 에피소드가 된 것 같습니다.
...
`실행 과정`
- 피어세션 시간에 팀원들의 체크인 메시지를 이용하여 AI로부터 노래를 추천받았다
  - IU - "에잇"
  - 볼빨간 사춘기 - "나만, 봄"
- 신나는 분위기를 원해서 힙합 장르로 추천해달라고 하였다
  - B-Free – "My Team"
  - Paloalto - "Good Times"
  - The Quiett – "Prime Time"
  - E SENS – "Flight"
- 노래들 중에서 Good Times가 주는 분위기나 느낌이 특히 좋다고 생각했다
- 해당 곡을 배경음악으로 설정할까 고민하였으나, 말을 많이 주고받는 피어세션의 특성상 음악이 방해가 될 수 있다고 판단하여 재생은 하지 않았다

`느낀 점 및 배운점`
- 음악은 감정과 분위기에 변화를 줄 수 있는 효과적인 도구라는 것을 다시금 느꼈다
- 특히, 피어세션과 같이 어색하거나, 준비가 필요한 활동 전에 듣는 것은 마음을 안정시키는데 좋을 것 같다
- AI와 함께 노래를 고민하고 추천을 받아보면서, AI가 사용자 맞춤 도구로 얼마나 다양하게 활용될 수 있는지도 다시금 느꼈다

`아쉬운 점과 개선 아이디어`
- 말 중심의 피어세션 환경에서는 음악이 오히려 집중을 방해할 수 있다고 생각했다
- 피어세션 시작 전에 팀원들과 함께 노래를 듣고 시작하는 방식이었다면 더 좋았을 것 같다
- 추천받은 노래를 각저 듣고 온 뒤 그와 관련된 이야기로 아이스브레이킹을 하는 것도 좋을 것 같다
- 클래식 음악처럼 저자극 배경음악을 활용하는 방법도 생각해볼 수 있을 것 같다
