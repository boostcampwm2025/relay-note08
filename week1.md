...
다만 다른 프롬프트 없이 노래 추천만 해달라고 했을 때는 괜찮았는데, 가사 기반으로 추천해달라고 했을 때는 자꾸 없는 가사를 창작하면서 추천해줘서 진짜 이런 노래가 맞는지 따로 확인하는 작업을 추가적으로 해줘야 했습니다. (ChatGPT한테 다시 확인해도 다른 가사로 바꿔서 또 창작했습니다.. 😓)   
...
정확도가 비교적 중요하지 않은 퀘스트라고 생각해서 할루시네이션도 하루를 웃으면서 시작할 수 있는 재미있는 에피소드가 된 것 같습니다.
