...
**표현 방식**  
ComfuUI에서 Stable Diffusion XL Base 모델을 활용했습니다. 먼저, KSampler에서 낮은 step, 높은 cfg로 러프한 구도와 모티브를 잡았습니다. 이후 image to image 생성으로 높은 step으로 디테일한 표현을 반복적으로 얹으며 의도가 가장 잘 드러나는 이미지를 생성했습니다. 보다 추상적이고 변형된 시각 표현을 위해 cfg를 높게 유지했습니다.  
