...
- 메뉴 선택을 함께 하며 협업감 형성  
### ✅ 달성 기준  
1. 점심시간 전 커뮤니티에 ‘AI 점심 메뉴 정령님’을 소환함  
2. 팀원들이 원하는 메뉴 키워드를 제시함 (#뜨끈한 국물 등)  
3. AI에게 “이 키워드를 모두 만족시키는 기발한 점심 메뉴를 추천해 줘!”라고 요청함  
4. AI의 답변을 보고 대화를 나누고, 해당 메뉴를 먹은 경우 인증샷을 공유함
---
# 🎧 미션: 취향으로 찾는 소울메이트  
## 감동을 나누는 콘텐츠 공유 실험
### 🪴 배경  
